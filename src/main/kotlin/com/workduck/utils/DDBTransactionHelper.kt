...
class DDBTransactionHelper(
    ...
    fun transactionWrite(transactionWriteRequest: TransactionWriteRequest?, config: DynamoDBMapperConfig, client: AmazonDynamoDB) {
        ...
        client.transactWriteItems(applyTransactionOperationUserAgent(transactWriteItemsRequest))
