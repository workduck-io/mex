...
@JsonSubTypes(
    ...
    JsonSubTypes.Type(value = EntityTypeRequest::class, name = "EntityTypeRequest"),
    JsonSubTypes.Type(value = HighlightInstanceRequest::class, name = "HighlightInstanceRequest"),
